 ...
 * Compile without OpenMP:  gcc -g -Wall -o seq_pi_monte_carlo
 *                  seq_pi_monte_carlo.c my_rand.c
 *            *needs my_rand.c, my_rand.h
 
 *Compile with OpenMP:     gcc -g -Wall -fopenmp -o omp_pi_monte_carlo omp_pi_monte_carlo.c my_rand.c
 *            *needs my_rand.c, my_rand.h
 *
 * Run for OpenMP:       ./omp_pi_monte_carlo <number of threads>
 *                  <number of tosses>
 *
 * Input:     None
...
#  pragma omp parallel for num_threads(thread_count) \
      reduction(+: number_in_circle) schedule(runtime)
